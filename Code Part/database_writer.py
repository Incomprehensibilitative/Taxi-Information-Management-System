...
def write_data(system):
    ...
    for inv in system.get_list("invoice"):
        sheet4.append((inv.get_id(), inv.get_customer_id(), inv.get_driver_id(), inv.get_date().date(), inv.get_payment_mode(), inv.get_distance(), inv.get_price_per_km(), inv.get_total()))
